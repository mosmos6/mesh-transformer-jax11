...
class TransformerLayerShard(nn.Module):
    ...
    def setup(self):
        ...
        self.q = nn.Dense(self.dim_per_head, use_bias=False)  # Use instance attributes now
        self.v = nn.Dense(self.dim_per_head, use_bias=False)
        self.k = nn.Dense(self.dim_per_head, use_bias=False)
        ...
        self.dense_proj = nn.Dense(self.dim_per_head * 4)
